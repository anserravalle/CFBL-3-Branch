...
<section class="section bg--default" style="--section-pt:80px;--section-pb:80px;"><div class="page-width"><div class="section__inner">
  <div class="section__header is-center"><p class="eyebrow">Credentials &amp; Trust</p><h2>Credentials &amp; Certifications</h2><p class="section__subheading">Select a credential to read more.</p></div>
  <div class="tabs" data-tabs><div class="tabs__list" role="tablist" aria-label="Credentials">
    <button type="button" role="tab" class="tabs__tab" id="ct0" aria-controls="cp0" aria-selected="true" tabindex="0">EMDR</button><button type="button" role="tab" class="tabs__tab" id="ct1" aria-controls="cp1" aria-selected="false" tabindex="-1">TF-CBT</button><button type="button" role="tab" class="tabs__tab" id="ct2" aria-controls="cp2" aria-selected="false" tabindex="-1">DBT</button><button type="button" role="tab" class="tabs__tab" id="ct3" aria-controls="cp3" aria-selected="false" tabindex="-1">ACT</button><button type="button" role="tab" class="tabs__tab" id="ct4" aria-controls="cp4" aria-selected="false" tabindex="-1">Ecotherapy</button>
  </div><div class="tabs__panels">
    <div role="tabpanel" class="tabs__panel" id="cp0" aria-labelledby="ct0" tabindex="0" ><h3>Certified EMDR Therapist & EMDRIA Approved Consultant</h3><div class="rte"><p>EMDR helps the brain reprocess painful or stuck experiences, so trauma loses its grip and healing can move forward.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp1" aria-labelledby="ct1" tabindex="0" hidden><h3>Certified Trauma-Focused CBT Therapist</h3><div class="rte"><p>A structured, evidence-based approach that gently reduces symptoms and helps young people, and their families, find steadier ground.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp2" aria-labelledby="ct2" tabindex="0" hidden><h3>Dialectical Behavior Therapy</h3><div class="rte"><p>Concrete skills, regulation, distress tolerance, mindfulness, that make daily life more livable.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp3" aria-labelledby="ct3" tabindex="0" hidden><h3>Acceptance and Commitment Therapy</h3><div class="rte"><p>We build psychological flexibility and reconnect your daily choices with what matters most.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp4" aria-labelledby="ct4" tabindex="0" hidden><h3>Certified through the Earth Body Institute</h3><div class="rte"><p>Nature-based practices that support reflection, regulation, and a felt sense of calm.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div>
  </div></div>
  <div class="section__header is-center" style="margin-top:var(--space-64)"><h2>Core Clinical Credentials</h2></div>
  <div class="grid grid--3 mobile-2"><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">EMDR Certified Therapist</h3><p class="credential__text">Advanced training in EMDR to support processing of trauma and distressing experiences.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Trauma-Focused CBT (TF-CBT)</h3><p class="credential__text">Structured, evidence-based treatment for children and adolescents impacted by trauma.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Dialectical Behavior Therapy (DBT)</h3><p class="credential__text">Emotion regulation, distress tolerance, interpersonal effectiveness, mindfulness.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Acceptance and Commitment Therapy (ACT)</h3><p class="credential__text">We build psychological flexibility and reconnect your daily choices with what matters most.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Ecotherapy</h3><p class="credential__text">Nature-based interventions for reflection, regulation, and wellbeing.</p></div></div></div>
  <div class="section__header is-center" style="margin-top:var(--space-64)"><h2>Additional Training &amp; Integrative Approaches</h2></div>
  <div class="grid grid--3 mobile-2"><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Internal Family Systems (IFS)</h3><p class="credential__text">Compassionate engagement with internal emotional parts.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Emotional Freedom Technique (EFT)</h3><p class="credential__text">Tapping-based approach to support emotional regulation.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Trauma-Conscious Yoga (TCY)</h3><p class="credential__text">Trauma-sensitive, body-based practices for regulation.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Somatic Psychology (SP)</h3><p class="credential__text">Mind-body awareness with attention to nervous-system functioning.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Mindfulness-Based Stress Reduction</h3><p class="credential__text">Awareness, reduced reactivity, and intentional responses to stress.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Breathwork</h3><p class="credential__text">Structured breathing for grounding and emotional awareness.</p></div></div></div>
</div></div></section>
<section class="section bg--sand" style="--section-pt:80px;--section-pb:80px;"><div class="page-width"><div class="section__inner">
