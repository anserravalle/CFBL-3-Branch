...
<section class="section bg--default" style="--section-pt:80px;--section-pb:80px;"><div class="page-width"><div class="section__inner">
  ...
  <div class="tabs" data-tabs><div class="tabs__list" role="tablist" aria-label="Credentials">
    ...
    <div role="tabpanel" class="tabs__panel" id="cp0" aria-labelledby="ct0" tabindex="0" ><h3>Certified EMDR Therapist & EMDRIA Consultant</h3><div class="rte"><p>Advanced training in Eye Movement Desensitization and Reprocessing to support the processing of trauma.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp1" aria-labelledby="ct1" tabindex="0" hidden><h3>Certified Trauma-Focused CBT Therapist</h3><div class="rte"><p>Evidence-based treatment for children and adolescents impacted by trauma.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp2" aria-labelledby="ct2" tabindex="0" hidden><h3>Dialectical Behavior Therapy</h3><div class="rte"><p>Emotion regulation, distress tolerance, interpersonal effectiveness, and mindfulness.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp3" aria-labelledby="ct3" tabindex="0" hidden><h3>Acceptance and Commitment Therapy</h3><div class="rte"><p>Psychological flexibility and values-based action.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div><div role="tabpanel" class="tabs__panel" id="cp4" aria-labelledby="ct4" tabindex="0" hidden><h3>Certified Earth Body Institute</h3><div class="rte"><p>Nature-based interventions to support reflection and regulation.</p></div><p style="margin-top:16px"><a class="btn btn--secondary" href="#">Learn more</a></p></div>
  </div></div>
  <div class="section__header is-center" style="margin-top:var(--space-64)"><h2>Core Clinical Credentials</h2></div>
  <div class="grid grid--3 mobile-2"><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">EMDR Certified Therapist</h3><p class="credential__text">Advanced training in EMDR to support processing of trauma and distressing experiences.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Trauma-Focused CBT (TF-CBT)</h3><p class="credential__text">Structured, evidence-based treatment for children and adolescents impacted by trauma.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Dialectical Behavior Therapy (DBT)</h3><p class="credential__text">Emotion regulation, distress tolerance, interpersonal effectiveness, mindfulness.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Acceptance and Commitment Therapy (ACT)</h3><p class="credential__text">Psychological flexibility and values-based action.</p></div></div><div class="credential"><span class="credential__icon">&#9679;</span><div><h3 class="credential__title">Ecotherapy</h3><p class="credential__text">Nature-based interventions for reflection, regulation, and wellbeing.</p></div></div></div>
